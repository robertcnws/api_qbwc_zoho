...
class ZohoFullInvoice(models.Model):
    ...
    payment_discount = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    credits_applied = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    payment_made = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    ...
    tax_total = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    ...
    discount_applied_on_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    ...
    shipping_charge_exclusive_of_tax = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    shipping_charge_inclusive_of_tax = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    ...
    bcy_shipping_charge = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    bcy_adjustment = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    bcy_sub_total = models.DecimalField(max_digits=10, decimal_places=2)
    bcy_discount_total = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    bcy_tax_total = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    bcy_total = models.DecimalField(max_digits=10, decimal_places=2)
    total = models.DecimalField(max_digits=10, decimal_places=2)
    balance = models.DecimalField(max_digits=10, decimal_places=2)
    write_off_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    roundoff_value = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    transaction_rounding_type = models.CharField(max_length=50)
    is_inclusive_tax = models.BooleanField(default=False)
    sub_total_inclusive_of_tax = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    ...
    unused_retainer_payments = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    tax_amount_withheld = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
